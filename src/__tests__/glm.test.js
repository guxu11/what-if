...
describe("GLM (Guidance & Learning Model)", () => {
  ...
  describe("createCustomScenario", () => {
    it("should create a custom scenario with valid structure", () => {
      const scenario = createCustomScenario("My Scenario", "What should I do?", [
        "Option A",
        "Option B",
        "Option C",
      ]);
    ...
    it("should create choices with correct structure", () => {
      const scenario = createCustomScenario("Test", "Question?", ["Opt 1", "Opt 2"]);
    ...
    it("should handle empty options gracefully", () => {
      const scenario = createCustomScenario("Test", "Question?", [
        "Option A",
        "",
        "   ",
        "Option B",
